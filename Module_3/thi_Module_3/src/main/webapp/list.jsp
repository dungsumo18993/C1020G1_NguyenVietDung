...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #194d40; width: 100%">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="navbar-brand" href="/employee?action=" style="color: white">Product</a>
            </li>
            <li class="nav-item">
                <a class="navbar-brand" href="/customers?action=" style="color: white">Employee</a>
            </li>
            <li class="nav-item">
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                                <a href="/employee?action=edit&id=${product.id}" style="color: white">Edit</a>
                            </button>
